...
class DashboardController extends Controller
{
    ...
    public function kuota()
    {
        ...
        $sisakuota = DB::select( "SELECT
            ...
            COUNT(CASE WHEN form_pengajuan_beasiswa.status = 'proses' THEN 1 END) AS total_daftar,
            CASE
        ...
        AND form_pengajuan_beasiswa.status = 'proses' GROUP BY jurusan.id
                ");
      
        return view('dashboard', compact('kuota','total','jumlahkuota','sisakuota','kuotaprodi'));
